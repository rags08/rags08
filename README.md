...
### **1. Advanced Svelte Spreadsheet App**
*(In progress — personal project)*  
A full Excel-like spreadsheet built entirely in **Svelte**, with:  
✔ Editable cells  
✔ Copy/Paste  
✔ Drag-fill  
✔ Filtering, sorting & pagination  
✔ Styles (bold, italic, borders, colors)  
✔ XLSX import/export  

**Tech Stack:** Svelte • SvelteKit • JavaScript • Tailwind

---

### **2. Portfolio Website (Dark/Light Theme)**  
A modern personal portfolio inspired by elegant minimal design.  
Includes smooth scrolling, theme toggling, and responsive layout.

**Tech Stack:** SvelteKit • Tailwind CSS

---

### **3. CRUD Dashboard UI (Svelte)**  
...
**Tech Stack:** Svelte • JavaScript • Tailwind • Postman APIs
